...
export const CityPlayers = {
    ...
    BAKER : { id: 12, img: "loaf-of-bread-svgrepo-com.svg", nev: "Pék", desc: "Ha meghalsz, 3 körön belül végetér a játék éhhalállal.", basic: false, evil: false, gmnight: 0, winalone: false, nightSpeech: ''},
    HOOVER : { id: 13, img: "vacuum-cleaner-svgrepo-com.svg", nev: "Porszívóügynök", desc: "Minden éjjel adsz valakinek egy porszívót. Ha minden élőnek van porszívója és a vízipisztolyos is él, nyersz.", basic: false, evil: false, gmnight: 1, winalone: true, nightSpeech: 'Kit ajándékozik meg a porszívóügynök?'},
